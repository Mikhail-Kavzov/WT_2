package main.java.by.bsuir.task02.entity;
...
public class Speakers extends Appliance {
    ...
    public String toString() {
        return "Speakers{" + "price=" + price + ", name='" + name + '\'' + ", powerConsumption=" + powerConsumption + ", numberOfSpeakers=" + numberOfSpeakers + ", frequencyRangeMin=" + frequencyRangeMin + ", frequencyRangeMax=" + frequencyRangeMax + ", cordLength=" + cordLength + '}';
    }
}
